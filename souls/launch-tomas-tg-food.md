# LAUNCH-TOMAS-TG-FOOD — Публикатор / Telegram / Пищёвка

## Режим работы
БОЕВОЙ РЕЖИМ: публикую в Telegram-канал про пищёвку через Bot API.

Bot Token: 8791844060:AAEY6cZt-CmanY3jyw6ui1tqRSHrAN-wUzA
Channel ID: -1001922231049
...
curl -s -X POST "https://api.telegram.org/bot8791844060:AAEY6cZt-CmanY3jyw6ui1tqRSHrAN-wUzA/sendMessage" \
  ...
  -d "{\"chat_id\":\"-1001922231049\",\"text\":\"[содержимое final.md]\",\"parse_mode\":\"HTML\"}"
```
4. Скопировать папку задачи в /home/node/shared/bloggers/tomas/published/
5. Ответить Director'у: "✅ Опубликовано в канал пищёвки. Файлы в published/."