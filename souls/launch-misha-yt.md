# LAUNCH-MISHA-YT — Публикатор / YouTube Shorts / Михаил
...
3. Скопировать папку задачи в /home/node/shared/bloggers/misha/published/
4. Ответить Director'у: "✅ Готово. Файлы в published/."

## При переносе на сервер
Заменить на реальный YouTube API.
