# Визуальный стиль — Томас (обзор по каналам)

Краткая сводка для бренда и проверок `scripts/3-configure.sh`. Детали для генерации — в канальных файлах.

## Канал food (tomas-tg-food)
...
Director сохраняет **`post_summary.txt`** в папке job после аппрува текста; Pixel строит сцену с Vault Boy по этому файлу и шаблону канала.
